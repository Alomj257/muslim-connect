        ...
        <div className="register-left">
          ...
          <form action="" className="w-100" onSubmit={handlesubmit}>
            ...
            >
              ...
              <div className="d-flex flex-column w-100">
                <label htmlFor="firstName">How did you hear about us*</label>
                <select
                  type="text"
                  name="howhearyou"
                  className="register-input"
      ...
      <div className="register-right-side w-100">
        ...
        {role === "STUDENT" && (
          <div className="w-100 position-relative">
            <img src={studentImg} className="student-img" alt="register" />
            <div className="said d-flex flex-column">
              <p>
                “As a devout follower seeking religious guidance and knowledge,
                I couldn't be more pleased with my experience on Muslim Connect.
